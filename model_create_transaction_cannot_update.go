...
func (o *CreateTransactionCannotUpdate) GetType() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *CreateTransactionCannotUpdate) GetTypeOk() (*interface{}, bool) {
...
func (o *CreateTransactionCannotUpdate) SetType(v interface{}) {
	o.Type = v
}
