...
func (o *CreateOrUpdateTransaction) GetCustomerEmailAddress() string {
...
// and a boolean to check if the value has been set.
func (o *CreateOrUpdateTransaction) GetCustomerEmailAddressOk() (*string, bool) {
	if o == nil || IsNil(o.CustomerEmailAddress) {
		return nil, false
	}
...
func (o *CreateOrUpdateTransaction) HasCustomerEmailAddress() bool {
	if o != nil && !IsNil(o.CustomerEmailAddress) {
		return true
	}
...
func (o *CreateOrUpdateTransaction) SetCustomerEmailAddress(v string) {
