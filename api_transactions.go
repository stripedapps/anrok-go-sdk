...
func (r ApiTransactionsListRequest) TransactionsListRequest(transactionsListRequest TransactionsListRequest) ApiTransactionsListRequest {
	r.transactionsListRequest = &transactionsListRequest
	return r
}
...
*/
func (a *TransactionsAPIService) TransactionsList(ctx context.Context) ApiTransactionsListRequest {
	return ApiTransactionsListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *TransactionsAPIService) TransactionsListExecute(r ApiTransactionsListRequest) (*InlineObject1, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/seller/transactions/list"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.transactionsListRequest == nil {
		return localVarReturnValue, nil, reportError("transactionsListRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.transactionsListRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
